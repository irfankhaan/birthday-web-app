...
(function animloop(){
   ...
   if (count123 > 500000 && count123 < 600000) {
     requestAnimFrame(animloop);
     update1();   
   }
   else if(count123 >= 600000){
      if(checkParticle()){
...
//今天有了你世界更精彩，今天有了你星空更灿烂，今天因为你人间更温暖，今天因为你我觉得更幸福!祝你生日快乐!
      ...
      strings_1: [["  Happy birthday,", "  FAHERA!  "], ["   Say goodbye to", "   your teenage years"], ["and say hello"], ["to your ", " TWENTIES "], ["  Now watch this", "  silly video I ", "    made for your birthday"]],
...
function message(){
  window.open("https://instagram.com/happy.birthday.fahera");
  document
}
